...
import { createSubjectGrade, deleteSubjectGrades } from './grades.controller.js';
...
export const createStudent = async (req, res) => {
  try {
    ...
    if (subjects) {
      createSubjectGrade(newStudent._id.toString(), subjects, section, yearLevel);
    }
...
export const updateStudent = async (req, res) => {
  try {
    ...
    if (removedSubjects.length > 0) {
      await deleteSubjectGrades(student._id, removedSubjects, section);
    }
